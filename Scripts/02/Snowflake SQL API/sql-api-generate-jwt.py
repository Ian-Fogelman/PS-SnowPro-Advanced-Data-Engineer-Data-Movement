...
#  python sql-api-generate-jwt.py --account="HFSMUTH-EVB26016" --user="IFOGELMAN" --private_key_file_path="rsa_key.pem"
# https://docs.snowflake.com/en/_downloads/aeb84cdfe91dcfbd889465403b875515/sql-api-generate-jwt.py

# Before you execute this script, uninstall the JWT and PyJWT libraries and reinstall pyjwt and cryptography.
# Having both JWT and PyJWT install simultaneously causes errors!
#pip uninstall jwt 
#pip uninstall pyjwt
#pip install pyjwt
